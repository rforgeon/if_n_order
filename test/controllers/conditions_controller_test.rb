...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { cur_count: @condition.cur_count, item: @condition.item, key: @condition.key, name: @condition.name, order_count: @condition.order_count, user_id: @condition.user_id }
    end
  ...
  test "should update condition" do
    patch :update, id: @condition, condition: { cur_count: @condition.cur_count, item: @condition.item, key: @condition.key, name: @condition.name, order_count: @condition.order_count, user_id: @condition.user_id }
    assert_redirected_to condition_path(assigns(:condition))
  end
